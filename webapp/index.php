		...
		<main data-role="page" id="page0">
			...
			<article data-role="content">
				...
				<ul data-role="listview" data-inset="true">
					<li><a href="/webapp/insert.php">영화 정보 추가</a></li>
					<li><a href="/webapp/update_select.php">영화 정보 수정</a></li>
					<li><a href="/webapp/delete_select.php">영화 정보 삭제</a></li>
					<li><a href="/webapp/select_all.php">전체 영화 조회</a></li>
				</ul>
			</article>
